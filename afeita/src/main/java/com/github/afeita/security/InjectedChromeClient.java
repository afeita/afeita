...
public class InjectedChromeClient extends WebChromeClient {
    ...
    public InjectedChromeClient (String injectedName,Object obj) {
        this.obj = obj;
        mJsCallJava = new JsCallJava(injectedName, obj.getClass());
    }
    ...
    public boolean onJsPrompt(WebView view, String url, String message, String defaultValue, JsPromptResult result) {
        result.confirm(mJsCallJava.call(obj,view, message));
        return true;
    }
}
